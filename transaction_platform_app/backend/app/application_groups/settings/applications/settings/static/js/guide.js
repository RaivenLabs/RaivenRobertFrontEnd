...
export const program = {
    ...
    async render(sectionName, targetElement) {
        try {
            ...
            const templatePath = `/application_groups/${section}/applications/${section}/static/settingsguide.html`;
            ...
            const jsonPath = `/application_groups/${section}/application_group_root/static/data/settings_programs.json`;
