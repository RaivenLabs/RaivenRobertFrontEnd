...
export const program = {
    ...
    async render(sectionName, targetElement) {
        try {
            ...
            const templatePath = `/application_groups/${section}/applications/${section}/static/engagementpackageguide.html`;
            ...
            const jsonPath = `/application_groups/${section}/application_group_root/static/data/engagementpackage_programs.json`;
