...
{customer_id: "TECH001",
    company_name: "Hawkeye Holdings, ai",
    overview: {
        industry: "Technology",
    ...
    key_metrics: {
        ...
        practice_areas: [
            { name: "Enterprise AI Solutions", expertise_level: "Tier 1" },
            { name: "Process Automation", expertise_level: "Tier 1" },
            { name: "Data Analytics & Intelligence", expertise_level: "Tier 1" },
            { name: "Cloud Integration Services", expertise_level: "Tier 1" },
            { name: "Digital Transformation Consulting", expertise_level: "Tier 1" }
        ],
        risk_rating: "Low",
        engagement_level: "Strategic"
    },
    milestones: [
        { year: 2018, event: "Founded in Silicon Valley" },
        { year: 2019, event: "Launch of HawkeyeAI Platform" },
        { year: 2021, event: "Series C Funding ($250M)" },
        { year: 2023, event: "IPO on NASDAQ" }
    ],
    contacts: [
        {
            id: "CON009",
            ...
            title: "CEO",
            email: "elena.martinez@hawkeyeai.com",
        ...
        },
        {
            ...
            email: "james.wong@hawkeyeai.com",
    ...
    services: {
        consulting: {
            name: "Hawkeye Enterprise Solutions",
            services: [
    ...
    innovation: {
        technology: [
            "Next-gen Large Language Models",
        ...
        sustainability: [
            ...
            "AI Ethics Framework",
            "Inclusive AI Development Programs" 
        ]
    }
},
