...
import { authenticationConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const AuthenticationSidebar = ({ onSidebarChange }) => {
  const navigate = useNavigate();
  const [sectionItems, setSectionItems] = useState([]);

  useEffect(() => {
    console.log('Initial authenticationConfig:', authenticationConfig);
    
    // Safely set section items
    if (authenticationConfig?.sectionItems) {
      console.log('Setting section items:', authenticationConfig.sectionItems);
      setSectionItems(authenticationConfig.sectionItems);
    } else {
      console.warn('No section items found in authenticationConfig');
    }
  }, []);
