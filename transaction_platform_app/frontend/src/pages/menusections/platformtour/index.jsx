        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl mx-auto px-4">
          ...
          <div className="p-8 rounded-lg shadow-md">
            <h1 className="italic text-xl leading-relaxed">
              The Critical Unlock resides at the Intersection of Computational
              Automation, Data Intelligence and Sector Expertise. The pattern of
              the high volume transaction portfolio is the key.
            </h1>
          </div>
