...
import { winslowBooneConfig } from '../../../../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const WinslowBooneSidebar = ({ onSidebarChange }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {winslowBooneConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
...
export default WinslowBooneSidebar;
