  ...
  const steps = [
    {
      ...
      response:
        "I understand you're creating an adoption workflow. Let me help structure this process. Would you like me to include checkpoints for essential supplies and home preparation requirements specific to border collies?",
    },
    {
      ...
      analysis: {
        ...
        optimization:
          'Recommended parallel tracks for home preparation while waiting for application approval',
      },
    },
    {
      ...
      <div className="guide-wrapper">
        ...
        <header className="guide-header">
          <div className="guide-container">
            ...
            <p>
              From natural language process descriptions to fully automated
              workflows
            </p>
          </div>
        </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl mx-auto px-4">
            <div className="bg-lightGray p-8 rounded-lg shadow-md">
              <h1 className="italic text-xl leading-relaxed">
                ...
                automated workflows through natural language. Your expertise
                becomes living automation through conversation.
              </h1>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold text-royalBlue mb-3">
                  {feature.title}
                </h3>
                <p>{feature.desc}</p>
              </div>
        ...
        <section className="bg-gray-50 py-16 px-4 rounded-lg mt-12">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg mb-8">
              Start with a simple process description. Our AI-powered Design
              Center will guide you through creating your first automated
              workflow in minutes.
            </p>
            <button
              className="bg-royalBlue text-ivory px-8 py-4 rounded-lg text-lg 
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-royalBlue">
                      Identified Patterns
                    </h4>
