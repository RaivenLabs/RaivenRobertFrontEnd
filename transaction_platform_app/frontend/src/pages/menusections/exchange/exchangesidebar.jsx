...
import { exchangeConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const ExchangeSidebar = ({ onSidebarChange }) => {
  ...
  useEffect(() => {
    ...
    if (exchangeConfig?.sectionItems) {
      ...
      setSectionItems(exchangeConfig.sectionItems);
    } else {
      console.warn('No section items found in exchangeConfig');
    }
  }, []);
    ...
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      <div className="mb-6">
        <div className="text-2xl font-bold text-cyan mb-2 p-6">
          The Tangible Application Exchange
        </div>
