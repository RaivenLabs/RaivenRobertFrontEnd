 ...
 const getAllCustomers = () => {
   ...
   const systemCustomers = [
     { 
       ...
       customer_type: String(CUSTOMER_TYPES.GLOBAL)  // Convert to string
     },
     { 
       id: 'TANGIBLE', 
       company_name: 'Tangible', 
       customer_type: String(CUSTOMER_TYPES.TANGIBLE)  // Convert to string
     }
   ];

   const instanceValues = Object.values(CUSTOMER_INSTANCES).map(customer => ({
     ...customer,
     customer_type: String(customer.customer_type)  // Ensure consistent string type
   }));
