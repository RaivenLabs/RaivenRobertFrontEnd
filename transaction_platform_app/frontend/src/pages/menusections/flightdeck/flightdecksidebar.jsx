...
import { flightdeckConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const FlightDeckSidebar = ({ onSidebarChange }) => {
  ...
  useEffect(() => {
    ...
    if (flightdeckConfig?.sectionItems) {
      ...
      setSectionItems(flightdeckConfig.sectionItems);
    } else {
      console.warn('No section items found in flightdeckConfig');
    }
  }, []);
...
export default FlightDeckSidebar;
