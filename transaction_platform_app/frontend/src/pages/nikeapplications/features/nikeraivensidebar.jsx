...
import { nikeRaivenConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const NIKERaivenSidebar = ({ onSidebarChange }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {nikeRaivenConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
...
export default NIKERaivenSidebar;
