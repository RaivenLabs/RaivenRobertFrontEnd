...
const ModelDashboard = ({ projectId, projectName, projectType }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setServiceOrders(sampleServiceOrders);
        setLoading(false);
      }
    };
  ...
  // Sample service order data for Nimitz with provider Midway (fallback data)
  ...
  return (
    <div className="bg-gray-100 rounded-lg shadow-md">
      ...
      <div className="bg-gray-50 p-4 border-t border-gray-200 flex justify-between items-center rounded-b-lg">
        <div>Showing 1-{serviceOrders.length} of {serviceOrders.length} service orders</div>
        <div className="flex">
