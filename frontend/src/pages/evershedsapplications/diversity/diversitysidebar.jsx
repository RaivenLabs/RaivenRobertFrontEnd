...
import { diversityConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const DiversitySidebar = ({ onSidebarChange }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {diversityConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
...
export default DiversitySidebar;
