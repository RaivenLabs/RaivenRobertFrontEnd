...
import { financialServicesConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const FinancialServicesSidebar = ({ onSidebarChange }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {financialServicesConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
