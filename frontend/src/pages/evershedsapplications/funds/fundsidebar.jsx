...
import { fundMonitoringConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const FundSidebar = ({ onSidebarChange }) => {
    ...
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      <div className="mb-6">
        <div className="text-2xl font-bold text-cyan mb-2 p-6">
          Fund Monitoring Application by Eversheds
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {fundMonitoringConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
