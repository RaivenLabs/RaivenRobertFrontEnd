// src/pages/menusections/companyreport/paceaidasidebar.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';

import { paceAidaConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const PaceAidaSidebar = ({ onSidebarChange }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {paceAidaConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
...
export default PaceAidaSidebar;
