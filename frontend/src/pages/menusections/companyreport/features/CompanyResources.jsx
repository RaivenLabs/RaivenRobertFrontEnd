      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                features: ["Policy Library", "Compliance Documents", "Standard Procedures"]
              },
              {
                icon: <Building2 className="w-8 h-8" />,
                title: "Office Locations",
                description: "Find information about global offices and facilities",
                features: ["Office Directory", "Facility Maps", "Contact Information"]
              },
              {
                icon: <Network className="w-8 h-8" />,
                title: "Functional Leadership",
                description: "Connect with functional leads and department heads",
                features: ["Leadership Profiles", "Department Contacts", "Expertise Areas"]
              },
              {
              ...
              },
              {
                ...
                features: ["Strategic Goals", "Key Projects", "Innovation Programs"]
              }
            ].map((category, index) => (
        ...
        <section className="bg-white py-8 px-4 rounded-lg mb-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-semibold text-royalBlue mb-4">Resource Notes</h2>
            <div className="bg-lightGray p-6 rounded-lg">
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="text-royalBlue mr-2">•</span>
                  Contact your department administrator for access to restricted resources
                </li>
                <li className="flex items-start">
                  <span className="text-royalBlue mr-2">•</span>
