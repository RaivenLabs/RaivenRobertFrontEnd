...
let conciergeApplicationsConfig;
try {
  conciergeApplicationsConfig = require('../../../config/applicationNavigation/conciergeApplications/config');
} catch {
    ...
    <>
      <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
        ...
        <div className="flex-1 overflow-y-auto">
          {/* Section menu items */}
          {conciergeConfig.sectionItems.map((item) => (
            <div key={item.id}>
              <button
                onClick={() => {
