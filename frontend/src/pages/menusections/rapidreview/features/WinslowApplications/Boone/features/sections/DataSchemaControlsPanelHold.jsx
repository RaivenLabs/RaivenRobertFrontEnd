      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div 
              className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-royalBlue hover:bg-royalBlue/5 transition-colors"
            >
            ...
            <div className="space-y-4">
              <div className="border rounded-lg divide-y">
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">financial_statements_2024.pdf</div>
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      <option value="sample_document">Sample Document</option>
                      <option value="data_structure">Existing Data Structure</option>
                      <option value="diligence_checklist">Due Diligence Checklist</option>
                    </select>
                ...
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">due_diligence_report.docx</div>
                ...
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">contracts_summary.xlsx</div>
                      <div className="text-sm text-gray-500">3.6 MB</div>
                    </div>
                  </div>
              ...
              <div className="flex items-center text-sm text-green-600 bg-green-50 p-3 rounded-md border border-green-100">
                ...
                <p>1 of 3 documents uploaded successfully</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end mt-6 pt-4 border-t border-gray-200">
            <div className="flex flex-wrap gap-3">
              <button className="flex items-center gap-1 px-4 py-2 bg-royalBlue text-white rounded-md text-sm hover:bg-blue-700 transition-colors">
              ...
              <button className="flex items-center gap-1 px-4 py-2 bg-green-600 text-white rounded-md text-sm hover:bg-green-700 transition-colors">
