    ...
    <div className="guide-wrapper">
      ...
      <header className="guide-header">
        <div className="guide-container">
          ...
          <p>
            Transform locked, unstructured, random data stores into actionable
          ...
          {[
            {
              ...
              metric: 'Access Speed',
              description:
                'From months of manual work to minutes of automated processing',
            },
            {
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <span className="text-lg">
                  Every filing cabinet, every folder, every data room, every
                  document contains valuable data waiting to be unlocked
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-royalBlue mr-3 text-xl">•</span>
                <span className="text-lg">
                  Transform unstructured information into organized, available,
              ...
              <li className="flex items-start">
                <span className="text-royalBlue mr-3 text-xl">•</span>
                <span className="text-lg">
                  Enable data-driven decision making by making all your
