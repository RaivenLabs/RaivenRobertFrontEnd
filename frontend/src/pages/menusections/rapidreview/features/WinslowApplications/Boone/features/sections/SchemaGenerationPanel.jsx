...
const SchemaGenerationPanel = ({ uploadedFiles, documentType, briefingContext, onSchemaGenerated, projectInfo }) => {
  // State management
  ...
  const [analysisContext, setAnalysisContext] = useState({
    ...
    userNotes: '',
    previousAdjustments: [],
    briefingContext: briefingContext // Include briefing context
  });
  ...
  // Update context when briefing context changes
  useEffect(() => {
    if (briefingContext) {
      console.log("Updating analysis context with briefing context:", briefingContext);
      setAnalysisContext(prev => ({
        ...prev,
  ...
  const handleAnalyzeDocuments = async () => {
    ...
    try {
      console.log("Sending analysis context:", analysisContext);
          ...
          <div className="mb-6">
            ...
            <div className="mt-4 bg-blue-50 border border-blue-200 rounded-md p-4">
              ...
              <ul className="list-disc pl-5 text-blue-700">
                ...
                <li>Briefing Context: {analysisContext.briefingContext ? 'Available' : 'Not available'}</li>
              </ul>
            </div>
          </div>
