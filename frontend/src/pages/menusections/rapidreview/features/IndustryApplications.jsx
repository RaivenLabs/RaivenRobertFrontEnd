    ...
    <div className="guide-wrapper">
      ...
      <header className="guide-header">
        <div className="guide-container">
          ...
          <p>
            Domain-specific solutions for legal, sourcing, and claims management
          </p>
          <p>
            Purpose-built tools that understand your industry's unique
            challenges
          </p>
        </div>
      </header>
      ...
      <section className="bg-white py-10 px-4 rounded-lg mb-8 shadow-sm">
        ...
        <div className="max-w-4xl mx-auto">
          <ApplicationGroup
            apiEndpoint="/api/programs/rapidreview"
      ...
      <footer className="guide-footer">
        <p>
          ...
          Transforming industry-specific operations through intelligent
          automation.
        </p>
      </footer>
    </div>
