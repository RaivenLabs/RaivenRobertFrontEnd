        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden">
            <div className="bg-gray-50 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Internal tools powering your core operations
              </p>
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden">
            <div className="bg-gray-50 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Domain or practice group specialized applications
              </p>
              <ul className="space-y-2">
                {[
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden">
            <div className="bg-gray-50 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Configurable applications supporting external workflow
                collaboration
              </p>
              <ul className="space-y-2">
                <li className="text-sm font-semibold text-royalBlue mt-4">
                  Transaction Portal
                </li>
                {[
