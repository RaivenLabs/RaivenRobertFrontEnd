...
import { winslowSourcingHubConfig } from '../../../config/sectionNavigation';
import { ArrowLeft } from 'lucide-react';

const WinslowSourcingHubSidebar = ({ onSidebarChange }) => {
    ...
    <div className="flex flex-col h-full bg-sidebarDark text-ivory shadow-sidebar relative">
      <div className="mb-6">
        <div className="text-2xl font-bold text-cyan mb-2 p-6">
          Eversheds Merger Control Application
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Section menu items */}
        {winslowSourcingHubConfig.sectionItems.map((item) => (
          <div key={item.id}>
            <button
...
export default WinslowSourcingHubSidebar;
