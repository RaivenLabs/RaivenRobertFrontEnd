      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="bg-royalBlue text-ivory py-12 px-4 text-center rounded-lg mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl font-semibold">Enterprise Authentication</h1>
          </div>
          <p className="text-xl max-w-3xl mx-auto mb-2">
            World-class security meets seamless access management
          </p>
          <p className="text-lg max-w-3xl mx-auto">
            Enterprise-ready authentication with SSO integration and granular access controls
          </p>
        </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                title: "Access Levels",
                description: "Granular control over platform and application access",
                features: [
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={index} 
                ...
                <div>
                  <span className="font-medium block mb-1">{benefit.label}</span>
        ...
        <section className="bg-white py-8 px-4 rounded-lg mb-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-semibold text-royalBlue mb-4">Security Standards</h2>
        ...
        <footer className="bg-royalBlue text-ivory text-center py-8 px-4 mt-12 rounded-lg">
          <p>© 2024 Tangible Intelligence, ai. The Tangible Intelligence Platform. 
             Enterprise-grade security without compromise.</p>
        </footer>
      </div>
    </div>
  );
