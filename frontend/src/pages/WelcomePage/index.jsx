    ...
    <div className="guide-wrapper">
      ...
      <header className="guide-header">
        <div className="guide-container">
          <h1>Transform Enterprise Operations with CoIntelligent Technologies</h1>
          <p>
            Balance speed, efficiency, and risk through advanced intelligence
          </p>
          <p>
            Purpose-built solutions for transaction management, compliance, and sourcing teams
          </p>
        </div>
      </header>
      ...
      <section className="bg-white py-10 px-4 rounded-lg mb-8 shadow-sm">
        <h2 className="text-2xl font-semibold text-royalBlue mb-8 text-center">Core Technologies</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="border border-gray-200 rounded-xl overflow-hidden">
            <div className="bg-gray-50 p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">CoreIntel™ Technology</h3>
              <p className="text-gray-600 mb-4">Transform unstructured data into actionable intelligence</p>
            </div>
          </div>
      ...
      {/* Impact Metrics */}
      <section className="bg-white py-10 px-4 rounded-lg mb-8 shadow-sm">
        <h2 className="text-2xl font-semibold text-royalBlue mb-8 text-center">Measurable Impact</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div key={index} className="text-center p-6 bg-gray-50 rounded-xl border border-gray-200">
              <div className="text-3xl font-bold text-royalBlue mb-2">{item.metric}</div>
              <div className="font-semibold text-gray-800 mb-1">{item.description}</div>
      ...
      {/* Who We Serve */}
      <section className="bg-white py-10 px-4 rounded-lg mb-8 shadow-sm">
        <h2 className="text-2xl font-semibold text-royalBlue mb-8 text-center">Who We Serve</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            {
      ...
      <footer className="guide-footer">
        <p>© 2024 Tangible Intelligence, ai. Transform your operations through intelligent automation.</p>
      </footer>
    </div>
  );
};
