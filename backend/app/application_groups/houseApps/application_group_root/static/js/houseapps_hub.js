...
console.log('Loading houseapps_hub.js...');
...
export const program = {
    ...
    setupHouseAppHandlers() {
        document.addEventListener('click', async (e) => {
            ...
            try {
                const { handler } = await import('/application_groups/houseapps/applications/houseapps/static/handlers/houseapps_handler.js');
