...
console.log('Loading tangibleteams_hub.js...');
...
export const program = {
    ...
    setupHouseAppHandlers() {
        document.addEventListener('click', async (e) => {
            ...
            try {
                const { handler } = await import('/application_groups/tangibleteams/applications/tangibleteams/static/handlers/tangibleteams_handler.js');
