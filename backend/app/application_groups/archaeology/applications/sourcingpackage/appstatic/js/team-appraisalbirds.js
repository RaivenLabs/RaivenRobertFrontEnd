...
export const program = {
   launch: function(section, container) {
       ...
       container.innerHTML = `
           <div style="display: flex; width: 100%; min-height: 100vh;">
               <div class="appraisal-sidebar" style="width: 250px;">
   ...
   showDashboard() {
       ...
       document.querySelector('.appraisal-content').innerHTML = dashboardContent;
