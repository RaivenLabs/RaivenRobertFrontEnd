export const program = {
    ...
    async loadStyles() {
        if (!document.querySelector('link[href*="data_table.css"]')) {
            ...
            link.rel = 'stylesheet';
            link.href = '/application_groups/houseapps/applications/teamappraisal/static/css/data_table.css';
    ...
    async loadAppraisalData() {
        try {
            const { appraisalData } = await import('/application_groups/houseapps/applications/teamappraisal/static/data/appraisal-sample-data.js');
